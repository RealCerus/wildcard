...
public class Paths implements Iterable<String> {
    static private final Comparator<Path> LONGEST_TO_SHORTEST = (s1, s2) ->
            s2.absolute().length() - s1.absolute().length();
    ...
    public Paths glob(String dir, List<String> patterns) {
        ...
        glob(dir, false, patterns.toArray(new String[0]));
        return this;
    }
    ...
    public boolean delete() {
        ...
        pathsCopy.sort(LONGEST_TO_SHORTEST);
